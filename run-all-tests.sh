...
#
# Default mode (~50s): lint + the -short integration suite (skips the
# cross-process / Python-interop tests) — enough for ~99% confidence before
# pushing. The FULL suite runs in GitHub CI on every push; run it locally
# with:
#
